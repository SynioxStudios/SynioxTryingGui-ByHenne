...
Gift:AddLabel("Gifting System").TextSize = 20
...
local eggDropdown = Gift:AddDropdown("Select Player Gift Egg", function(selectedDisplayName)
...
local shakeDropdown = Gift:AddDropdown("Select Player Gift Shake", function(selectedDisplayName)
    for _, plr in ipairs(Players:GetPlayers()) do
        if plr.DisplayName == selectedDisplayName then
